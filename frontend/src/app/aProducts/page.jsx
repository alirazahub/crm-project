...
import { Plus, Save, Upload, X, Eye, EyeOff, Star, Package, Tag, Image as ImageIcon, Settings, Truck } from 'lucide-react';
...
export default function AdminProductPage() {
  ...
  const categories = ['Electronics', 'Clothing', 'Home & Garden', 'Sports', 'Books', 'Beauty', 'Automotive', 'Food', 'Toys', 'Health'];
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-9">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Basic Information */}
              {activeTab === 'basic' && (
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 transform transition-all duration-500 animate-in slide-in-from-right">
                    ...
                    <div className="col-span-2">
                      ...
                      <div className="flex gap-2 mb-3 flex-wrap">
                        {formData.tags.map((tag, index) => (
                          <span key={index} className="inline-flex items-center gap-1 px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full text-sm font-medium">
                            {tag}
                      ...
                      <div className="space-y-3 mb-4">
                        {formData.variants.map((variant, index) => (
                          <div key={index} className="flex items-center gap-4 p-4 bg-white rounded-lg border border-slate-200">
                            <span className="font-medium text-slate-700">{variant.name}: {variant.value}</span>
