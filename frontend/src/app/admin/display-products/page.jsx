                ...
                <div className="grid grid-cols-3 gap-4 p-4 bg-slate-800/30 rounded-xl border border-slate-700/30">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 bg-slate-800/50 border border-slate-700/50 text-slate-100 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-300"
                    >
                      <option value="name" className="bg-slate-800 text-slate-100">Name</option>
                      <option value="price" className="bg-slate-800 text-slate-100">Price</option>
                      <option value="category" className="bg-slate-800 text-slate-100">Category</option>
                      <option value="status" className="bg-slate-800 text-slate-100">Status</option>
                      <option value="createdAt" className="bg-slate-800 text-slate-100">Date Created</option>
                    </select>
                  </div>
                  <div>
                    <label className="block text-sm font-semibold text-slate-300 mb-2">
