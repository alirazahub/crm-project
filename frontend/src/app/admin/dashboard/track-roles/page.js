      ...
      <div className="container mx-auto p-4 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-3 lg:col-span-2">
            <AdminSidebar currentPath="/admin/track-roles" />
          </div>
            ...
            <div className="flex items-center justify-center min-h-[80vh]">
              <div className="space-y-6 w-full max-w-2xl">
                <div className="text-center mb-8">
                  <h1 className="text-3xl font-bold text-slate-100 mb-2">Role Overview</h1>
                  <p className="text-slate-400">Track user roles and their distribution</p>
                </div>
                ...
                <div className="group flex justify-between items-center p-6 bg-slate-900/50 border border-slate-700/50 backdrop-blur-sm rounded-lg shadow-xl hover:bg-slate-800/50 cursor-pointer transition-all duration-300 hover:scale-[1.02]">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <span className="text-xl font-semibold text-slate-100">Total Users</span>
                      <p className="text-sm text-slate-400">All registered users</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className="text-3xl font-bold text-blue-400">{data.users.count}</span>
                ...
                <div className="group flex justify-between items-center p-6 bg-slate-900/50 border border-slate-700/50 backdrop-blur-sm rounded-lg shadow-xl hover:bg-slate-800/50 cursor-pointer transition-all duration-300 hover:scale-[1.02]">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <span className="text-xl font-semibold text-slate-100">Sales Team</span>
                      <p className="text-sm text-slate-400">Sales representatives</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className="text-3xl font-bold text-green-400">{data.sales.count}</span>
                ...
                <div className="group flex justify-between items-center p-6 bg-slate-900/50 border border-slate-700/50 backdrop-blur-sm rounded-lg shadow-xl hover:bg-slate-800/50 cursor-pointer transition-all duration-300 hover:scale-[1.02]">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <span className="text-xl font-semibold text-slate-100">Managers</span>
                      <p className="text-sm text-slate-400">Management team</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <span className="text-3xl font-bold text-amber-400">{data.managers.count}</span>
