...
import { Plus, Save, Upload, X, Eye, Star, Package, Tag, ImageIcon, Truck, Activity, ChevronRight } from "lucide-react"
import { Card, CardHeader, CardTitle, CardContent } from "@/components/ui/card"
import { Button } from "@/components/ui/button"

export default function ProductForm({ initialData = null, mode = "add", onSubmit, onCancel, isLoading = false }) {
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-slate-400 mt-1 text-xs">Create and manage your product catalog</p>
                </div>
              </div>
              ...
              <nav className="space-y-2">
                {tabs.map((tab) => {
                  ...
                  return (
                    ...
                    >
                      <Icon size={16} className={activeTab === tab.id ? "text-cyan-500" : "text-slate-500"} />
                      {tab.label}
                      {activeTab === tab.id && <ChevronRight className="ml-auto h-3 w-3 text-cyan-500" />}
                    </Button>
                  )
                })}
              </nav>
                  ...
                  <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        {categories.map((cat) => (
                          <option key={cat} value={cat} className="bg-slate-800 text-slate-100 hover:bg-cyan-500">
                            {cat}
                          </option>
                        ))}
                      </select>
                    ...
                    <div>
                      <label className="block text-xs font-medium text-slate-300 mb-2">Brand</label>
                      <input
                        type="text"
                        name="brand"
                    ...
                    <div className="col-span-1 md:col-span-2">
                      <label className="block text-xs font-medium text-slate-300 mb-2">Short Description</label>
                      <input
                        type="text"
                ...
                <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                      ...
                      <div>
                        <label className="block text-xs font-medium text-slate-300 mb-2">Original Price</label>
                        <input
                          type="number"
                          name="originalPrice"
                      ...
                      <div>
                        <label className="block text-xs font-medium text-slate-300 mb-2">Cost Price</label>
                        <input
                          type="number"
                          name="costPrice"
                    ...
                    <div className="p-4 bg-slate-800/30 rounded-lg border border-slate-700/50">
                      ...
                      <div className="flex items-center mb-3">
                        ...
                        />
                        <label className="ml-2 text-xs text-slate-300">Enable Discount</label>
                      </div>
                ...
                <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      ...
                      <div>
                        <label className="block text-xs font-medium text-slate-300 mb-2">Low Stock Threshold</label>
                        <input
                          type="number"
                    ...
                    <div className="flex items-center">
                      <input
                        ...
                        className="w-3 h-3 text-cyan-600 rounded focus:ring-cyan-500 bg-slate-800 border-slate-700"
                      />
                      <label className="ml-2 text-xs text-slate-300">Track Inventory</label>
                    </div>
                  </CardContent>
                </Card>
              )}
                ...
                <Card className="bg-slate-900/50 border-slate-700/50 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    <div className="border-2 border-dashed border-slate-700/50 rounded-lg p-6 text-center hover:border-cyan-500/50 transition-all duration-200 bg-slate-800/20">
                      ...
                      <h3 className="text-sm font-medium text-slate-100 mb-2">Upload Product Images</h3>
                      <p className="text-slate-400 mb-3 text-xs">Drag and drop or select multiple images</p>
                      <input
                        type="file"
                        multiple
