...
//                     link={"/admin/display-products"}
//                   />
//                   <NavItem icon={Fingerprint} label="Track Roles" link={"/"} />
//                   <NavItem icon={ShoppingBag} label="Orders" />
//                   <NavItem icon={Users} label="Customers" />
//                   <NavItem icon={MessageSquare} label="Reviews" />
//                   <NavItem icon={Database} label="Testimonials" />
//                 </nav>
...
//   return (
//     <div className="grid grid-cols-12 items-center text-xs text-slate-300 px-3 py-2 hover:bg-slate-800/30">
//       <div className="col-span-1">{pid}</div>
